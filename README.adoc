...
:experimental:
:url-github: https://github.com/hyperpolymath/Axiom.jl
:url-gitlab: https://gitlab.com/hyperpolymath/Axiom.jl
:url-bitbucket: https://bitbucket.org/hyperpolymath/Axiom.jl
:url-codeberg: https://codeberg.org/hyperpolymath/Axiom.jl

Julia axiom verification and formal proof framework
...
Axiom.jl is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
